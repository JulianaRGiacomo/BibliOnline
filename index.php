        ...
        <script type="text/javascript">
            window.onload = function(){
                ...
                for (i = 0; i < full.length; i++){
                    full[i].style.width = width;
                }
                var height = window.innerHeight+"px";
                document.getElementById("cabecalho").style.height = height;                
            };
            setInterval(largura, 500);
        </script>
    </head>
    <body>
        <div id="login" style="visibility:hidden;opacity:0">
            <div id="form">
                <form action="login.php" method="post">
                    <input type="text" class="caixa metade invertida" name="email" placeholder="E-mail">
                    <input class="caixa metade  invertida" name="senha" placeholder="Senha" type="password">
                    <input class="botão invertido" onclick="location.href='home.php'" id="ir" type="submit" value="Ir!">
                </form>
            </div>
        </div>
        <div id="conteudo">
            <section id="main">
                ...
                <section id="cabecalho" class="full">
                    <a onclick="login();" href="javascript:void(0)" class="botão invertido" id="entrar">Entrar</a>
                    <section id="info">
                        <h1>BibliOnline</h1>
                        ...
                        <div style="width:50%" id="caixa-botão">
